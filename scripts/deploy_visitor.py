...
if project.get("projectName") != "tofu-tracker-demo" or project.get("orgId") != "team_cwjFWlUVzkCIYgVepQ6Glc71":
    raise SystemExit("Link the dedicated personal tofu-tracker-demo project first.")
files = subprocess.check_output(["git", "ls-files", "-z"], cwd=root).decode().split("\0")
with tempfile.TemporaryDirectory(prefix="tofu-tracker-app-deploy-") as directory:
